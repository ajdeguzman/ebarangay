...
export default function ThemeToggle({ className = "" }) {
  ...
  return (
    <button
      ...
      className={`h-9 w-9 rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--surface))] hover:bg-[rgb(var(--surface-2))] flex items-center justify-center transition ${className}`}
    >
      {isDark ? (
